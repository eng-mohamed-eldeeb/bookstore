...
const url = 'https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/HIfCVUlQOtaAt6fiFqBM/books';
...
export const deleteBook = (id) => async (dispatch) => {
  ...
  try {
    const delURL = `https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/HIfCVUlQOtaAt6fiFqBM/books/${id}`;
